...
export default function Login() {
  ...
  return (
    <div className="grid min-h-screen bg-canvas app-canvas lg:grid-cols-[1.05fr_1fr]">
      {/* Brand panel */}
      <div className="stripe-sheen relative hidden overflow-hidden p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="bg-grid-faint pointer-events-none absolute inset-0 opacity-[0.08]" />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(115deg,transparent_0_38%,rgba(255,255,255,0.08)_38%_43%,transparent_43%_100%)]" />

        <div className="relative flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-md bg-gradient-to-br from-primary to-primary-emphasis shadow-lg ring-1 ring-white/20">
            <Boxes className="h-5 w-5" />
          </div>
          <div className="leading-tight">
            <div className="text-sm font-semibold">Shiv Furniture</div>
        ...
        <div className="relative max-w-md">
          ...
          <h1 className="text-3xl font-semibold leading-tight">
            ...
            <span className="text-red-200"> operations center.</span>
          </h1>
          ...
          <div className="mt-10 space-y-5">
            {HIGHLIGHTS.map((h) => (
              <div key={h.title} className="flex gap-3.5">
                <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-white/10 bg-white/5">
                  <h.icon className="h-[18px] w-[18px] text-red-200" />
                </div>
                <div>
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="surface-panel w-full max-w-[420px] rounded-lg p-7">
          {/* Mobile brand */}
          <div className="mb-8 flex items-center gap-2.5 lg:hidden">
            <div className="flex h-9 w-9 items-center justify-center rounded-md bg-gradient-to-br from-primary to-primary-emphasis text-white shadow-sm">
              <Boxes className="h-5 w-5" />
            </div>
            <div className="text-sm font-semibold">Shiv Furniture Works</div>
          </div>
              ...
              {DEMO_ACCOUNTS.map((a) => {
                ...
                return (
                  <button
                    ...
                    className={
                      "rounded-md border px-3 py-2 text-left shadow-xs transition-colors " +
                      (active
